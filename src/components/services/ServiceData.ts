...
export const serviceDetails: ServiceDetails[] = [
  {
    ...
    description:
      "Ensure seamless operation from day one. Our experts manage the installation and commissioning process end-to-end, offering localized support and global experience.",
    fullDescription: [
    ...
    process: [
      {
        ...
        description:
          "We manage every stage of your project, from initial concept and engineering to complete installation and operational handover.",
      },
      {
        title: "Full System Design and Engineering",
        description:
          "Our experts design fully customized system layouts, electrical and mechanical schematics, and control architectures to meet your unique operational requirements.",
      },
      {
        title: "Equipment Installation",
        description:
          "Precise mechanical and electrical installation of all machinery and support systems, carried out to international safety and quality standards.",
      },
      {
        title: "Control System Integration",
        description:
          "We integrate advanced control and automation systems to ensure optimal machine performance and smooth coordination across your production lines.",
      },
      {
        title: "Equipment Overhaul and Upgrades",
        description:
          "Our team refurbishes, upgrades, or retrofits your existing equipment to extend its lifespan, improve reliability, and adapt to new production demands.",
      },
      {
        title: "Commissioning and Operator Training",
        description:
          "We carry out thorough functional testing, calibration, and system verification, and provide comprehensive training to your personnel for safe and efficient operation.",
      },
    ],
    images: [
  ...
  },
  {
    ...
    description:
      "We specialize in the safe and efficient dismantling, relocation and assembly of industrial equipment, including full production lines. Our global project experience ensures your assets arrive safely at their new location.",
    fullDescription: [
    ...
    process: [
      {
        title: "Dismantling",
        description:
          "Expert disassembly of machinery and equipment, ensuring safe handling and preparation for transport.",
      },
      {
        title: "Seaworthy Packaging",
        description:
          "Robust packaging solutions that protect your equipment against environmental factors during maritime transit.",
      },
      {
        title: "Oversized Equipment Handling",
        description:
          "Specialized techniques and equipment to manage the relocation of large or heavy machinery safely and efficiently.",
      },
      {
        title: "Transportation Logistics",
        description:
          "Coordinated logistics planning to ensure timely and secure delivery of equipment to its new location.",
      },
      {
        title: "Reassembly and Alignment at New Location",
        description:
          "Comprehensive reassembly of machinery by experienced technicians, including mechanical, electrical, and control system reconnections, precision alignment, and functional testing to ensure full operational readiness.",
      },
      {
        title: "Installation and Commissioning",
        description:
          "Final setup and fine-tuning of systems so your equipment is fully integrated and ready for immediate production.",
      },
    ],
    images: [
      "/lovable-uploads/d2d69cd4-0766-4486-9a80-b60fc87beae6.webp",
      "/lovable-uploads/d27b654c-f8b6-42c5-8da0-f6b4f1162ccb.webp",
      "/lovable-uploads/37477ea0-fd08-4236-a799-d4edb282d744.webp",
      "/lovable-uploads/af4043e2-9028-40ad-a179-44747b766517.webp",
      "/lovable-uploads/600c531c-712d-49aa-82cc-ca5fba294e27.webp",
      "/lovable-uploads/6ac5fc62-9f37-48a2-b672-80f564889cc5.webp",
      "/lovable-uploads/4f8a911d-51d1-44fc-a9d3-b22163157dbf.webp",
    ],
  },
  {
    id: "overhaul",
    ...
    description:
      "Restore and modernize your assets. We perform full equipment overhauls to increase longevity, energy efficiency, and operational performance—bringing outdated systems up to today's standards.",
    fullDescription: [
    ...
    process: [
      {
        ...
        description:
          "Comprehensive evaluation of current equipment condition, performance metrics, and failure points.",
      },
      {
      ...
      },
      {
        ...
        description:
          "We offer continued technical support, preventive maintenance recommendations, and process optimization services to maintain peak performance over time.",
      },
    ],
    images: [
      "/lovable-uploads/472d3798-6911-4d55-aa5b-ab0020bc50bf.webp",
      "/lovable-uploads/9f43e76c-a017-4d34-b836-2bbfbe8afbf9.webp",
      "/lovable-uploads/0f867536-23a9-44c5-b5ff-0ffee7b38a17.webp",
    ],
    beforeAfterImages: {
      before: ["/lovable-uploads/be4f94d9-0380-4116-a472-2cd43aa388ae.webp"],
      after: ["/lovable-uploads/be4f94d9-0380-4116-a472-2cd43aa388ae.webp"],
    },
  },
  {
    id: "engineering",
    ...
    description:
      "From design to deployment, our electrical engineering solutions support the safe, smart, and scalable control of your production infrastructure, enhancing efficiency and reducing downtime.",
    fullDescription: [
    ...
    process: [
      {
        ...
        description:
          "Custom electrical cabinet design and professional assembly for your specific control requirements.",
      },
      {
        title: "Control Systems Integration",
        description:
          "We integrate modern PLCs and automation technologies to streamline and enhance your production processes.",
      },
      {
    ...
    images: [
      "/lovable-uploads/99933b14-caab-4d71-8acb-e9670b38d1cf.webp",
      "/lovable-uploads/2d246b46-3ba2-4cdb-bca5-1e159a6ec659.webp",
      "/lovable-uploads/ce79528d-6a07-4b95-a327-f26d29ae5163.webp",
    ],
  },
];
