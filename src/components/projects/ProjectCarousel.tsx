...
const ProjectCarousel = ({ projects }: ProjectCarouselProps) => {
  ...
  return (
    <div className="max-w-6xl mx-auto relative px-8 md:px-0">
      ...
      <div ref={emblaRef} className="overflow-hidden">
        <div className="flex">
          {projects.map((project, index) => (
            ...
            >
              <div className="bg-white rounded-xl overflow-hidden shadow-lg p-4 md:p-8 min-h-[480px] md:min-h-[480px] mx-2 md:mx-0">
