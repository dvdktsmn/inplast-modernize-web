...
const Hero = () => {
  ...
  return (
    <div className="relative h-[70vh] md:h-[50vh] overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col justify-center items-center h-full container mx-auto text-center px-2 md:px-4 py-8">
        <img 
        ...
        <div className="flex flex-col sm:flex-row gap-4 animate-fade-in px-2 w-full max-w-lg md:max-w-none">
          <Button 
