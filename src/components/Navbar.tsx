      ...
      <div className="container mx-auto flex justify-between items-center py-2">
        ...
        <div className="hidden lg:flex space-x-8">
          {isHomePage ? (
            ...
            <Link to="/" className="text-white hover:text-inplast-orange transition-colors cursor-pointer">
              Home
            </Link>
          )}
          {isHomePage ? (
            ...
            <Link to="/products" className="text-white hover:text-inplast-orange transition-colors cursor-pointer">
              Expertise
            </Link>
          )}
          {isHomePage ? (
            ...
            <Link to="/services" className="text-white hover:text-inplast-orange transition-colors cursor-pointer">
              Services
            </Link>
          )}
          {isHomePage ? (
            ...
            <Link to="/projects" className="text-white hover:text-inplast-orange transition-colors cursor-pointer">
              Projects
            </Link>
          )}
        </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="outline"
                size="icon"
                className="border-white text-white bg-inplast-orange border-inplast-orange hover:bg-inplast-inplast-orange hover:border-inplast-blue"
              >
